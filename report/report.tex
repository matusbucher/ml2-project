...
While Burtsev's work focused on predicting next states and/or rules for an arbitrary CA, we focus on learning the next state for a fixed set of ECA rules. We aim to analyze and compare the learning dynamics of the model across different rules with varying degrees of complexity and structure. Then, we will explore the model's ability to generalize to longer sequences.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{../results/generalization_length/loss_history_comparison.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{../results/generalization_length/eval_history_comparison.png}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=\linewidth]{../results/generalization_length/cell_accuracy_comparison.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{../results/generalization_length2/eval_history_rule_90.png}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=\linewidth]{../results/generalization_length2/cell_accuracy_rule_90.png}
